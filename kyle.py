...
class Game:
    def __init__(self):
        self.tk = Tk()
        self.tk.title("Kyle run for Kenny")
        ...
        self.bg2 = PhotoImage(file="backgroundcm.gif")
        w = self.bg.width()
        h = self.bg.height()
        for x in range(0, 5):
            for y in range(0, 5):
    ...
    def mainloop(self):
        while 1:
            ...
            if self.running == False:
                ...
                door = DoorSprite(g, PhotoImage(file="door_open.gif"), 45, 30, 40, 35)
                g.sprites.append(door)
                g.sprites.append(sf)
                self.canvas.create_text(250,235,text='You find Kenny!', font=("Arial",16))
                door = DoorSprite(g, PhotoImage(file="door_open.gif"), 45, 30, 40, 35)
...
class StickFigureSprite(Sprite):
    ...
    def vanish(self):
        self.images_left = [
            PhotoImage(file="transparent.gif"),
            PhotoImage(file="transparent.gif"),
            PhotoImage(file="transparent.gif")
        ]
        self.images_right = [
        ...
        self.image = game.canvas.create_image(45, 30, image=self.images_left[0], anchor='nw')
        self.endgame = True            
...
class MovingPlatformSprite(Sprite):
    def __init__(self, game, photo_image, x, y, width, height):
        ...
        self.image = game.canvas.create_image(x, y, image=self.photo_image, anchor='nw')
        self.coordinates = Coords(x, y, x + width, y + height)
        self.game.canvas.move(self.coordinates, 10, 100)
    ...
    def draw(self):
        self.game.canvas.move(self.coordinates, self.x, 0)
...
g.sprites.append(platform9)
g.sprites.append(platform10)
platform11 = MovingPlatformSprite(g, PhotoImage(file="platform1.gif"),10, 100,100,10)
